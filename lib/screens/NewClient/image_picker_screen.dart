...
class _ImagePickerCurrentScreenState extends State<ImagePickerCurrentScreen> {
  ...
  initState() {
    ...
    fnameCtrl.text = appProv.userDetails['firstName'];
    lnameCtrl.text = appProv.userDetails['lastName'];
    emailCtrl.text = appProv.userDetails['email'];
    phoneCtrl.text = appProv.userDetails['phone'];
    uploadedFile=appProv.userDetails['photo_url'];
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  ...
                                  image: _imageFile != null
                                      ...
                                      : NetworkImage(
                                          getProvider().userDetails['photo_url'] !=""?getProvider().userDetails['photo_url']:
